...
struct AppColor {
    ...
    static let gray : Color = Color(red: 242/255, green: 242/255, blue: 247);
    ...
    static let gradientColorBottomRight : Color = Color(red: 194/255, green: 0, blue: 105/255)
    static let gradientColorTopLeft : Color  = Color(red: 1, green: 25/255, blue: 85/255)
